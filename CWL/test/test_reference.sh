...
cwltool --debug --tmpdir-prefix=`pwd`/work --basedir=`pwd`/base --outdir=`pwd`/out --cachedir=`pwd`/cache ${SRC_DIR}/../wgbs-workflow-pilot.yaml ${SRC_DIR}/../test/test-job-wfl-${2}.yml
