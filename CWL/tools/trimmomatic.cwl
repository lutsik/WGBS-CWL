...
inputs:
  ...
  tailcrop:
    ...
    doc: |
      <length>
      Removes the specified number of bases, regardless of quality, from the end of the read.
      ...
      glob: |
        ${
          if (inputs.end_mode == "PE")
            return inputs.input_read1_fastq_file.path.replace(/^.*[\\\/]/, '').replace(/\.[^/.]+$/, '') + '_unpaired_trimmed.fastq';
          return null;
        }
      ...
      glob: |
        ${
          if (inputs.end_mode == "PE" && inputs.input_read2_fastq_file)
            return inputs.input_read2_fastq_file.path.replace(/^.*[\\\/]/, '').replace(/\.[^/.]+$/, '') + '_trimmed.fastq';
          return null;
        }
  output_read2_trimmed_unpaired_file:
    ...
    outputBinding:
      glob: |
        ${
          if (inputs.end_mode == "PE" && inputs.input_read2_fastq_file)
            return inputs.input_read2_fastq_file.path.replace(/^.*[\\\/]/, '').replace(/\.[^/.]+$/, '') + '_unpaired_trimmed.fastq';
          return null;
        }
baseCommand: java
arguments:
...
- valueFrom: |
    ${
      if (inputs.end_mode == "PE" && inputs.input_read2_fastq_file)
        return inputs.input_read1_fastq_file.path.replace(/^.*[\\\/]/, '').replace(/\.[^/.]+$/, '') + '_trimmed_unpaired.fastq';
      return null;
    }
  position: 8
- valueFrom: |
...
- valueFrom: |
    ${
      if (inputs.end_mode == "PE" && inputs.input_read2_fastq_file)
        return inputs.input_read2_fastq_file.path.replace(/^.*[\\\/]/, '').replace(/\.[^/.]+$/, '') + '_trimmed_unpaired.fastq';
      return null;
    }
  position: 10
